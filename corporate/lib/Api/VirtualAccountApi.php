...
class VirtualAccountApi
{
     ...
     * @param  string $va_contract_auth_key 振込入金口座API認証情報 半角英数字 銀行契約の方はNULLを設定 提携企業の方が、契約された顧客の入金明細照会を依頼される場合は必須 提携企業以外の方が値を設定されている場合は「400 Bad Request」を返却  minLength: 1 maxLength: 400 (optional)
     ...
     * @return \Ganb\Corporate\Client\Model\VaDepositTransactionsResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\VaDepositTransactionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\VaDepositTransactionsResponse',
     ...
     *
     * @param  string $x_access_token アクセストークン  minLength: 1 maxLength: 128 (required)
     * @param  \Ganb\Corporate\Client\Model\VaIssueRequest $body HTTPリクエストボディ (optional)
     *
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ganb\Corporate\Client\Model\VaIssueResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\VaIssueResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\VaIssueResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $x_access_token アクセストークン  minLength: 1 maxLength: 128 (required)
     * @param  \Ganb\Corporate\Client\Model\VaStatusChangeRequest $body HTTPリクエストボディ (optional)
     *
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ganb\Corporate\Client\Model\VaStatusChangeResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\VaStatusChangeResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\VaStatusChangeResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $x_access_token アクセストークン  minLength: 1 maxLength: 128 (required)
     * @param  \Ganb\Corporate\Client\Model\VaCloseRequest $body HTTPリクエストボディ (optional)
     *
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ganb\Corporate\Client\Model\VaCloseRequestResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\VaCloseRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\VaCloseRequestResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $x_access_token アクセストークン  minLength: 1 maxLength: 128 (required)
     * @param  \Ganb\Corporate\Client\Model\VaListRequest $body HTTPリクエストボディ (optional)
     *
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ganb\Corporate\Client\Model\VaListResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\VaListResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\VaListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
