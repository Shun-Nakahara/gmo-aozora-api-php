...
class BulkTransferApi
{
     ...
     * 総合振込手数料事前照会
     *
     * @param  \Ganb\Personal\Client\Model\BulkTransferRequest $body HTTPリクエストボディ (required)
     * @param  string $x_access_token アクセストークン  minLength: 1 maxLength: 128 (required)
     *
     * @throws \Ganb\Personal\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Personal\Client\Model\BulkTransferRequestResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Personal\Client\Model\BulkTransferStatusResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
